...
const Statistics = ({ 
  ...
  return (
    <section className={`w-full py-6 sm:py-8 lg:py-10 ${showBackground ? getVariantStyles() : ''} ${className}`}>
              ...
              <div className="flex items-center justify-center mb-2 sm:mb-3">
                <div className="mr-2 sm:mr-3 lg:mr-4">
                  ...
                  />
                   ...
                   <div className={`text-2xl sm:text-3xl lg:text-[38px] font-[700] leading-tight sm:leading-tight lg:leading-[42px] ${
                     variant === 'about' ? 'text-brand-dark' : 'text-white'
                   }`}>
                     {stat.number}
                   </div>
                   <div className={`text-[10px] sm:text-xs lg:text-sm font-medium ${
                     variant === 'about' ? 'text-brand-gray-medium' : 'text-white'
                   }`}>
                     {stat.label}
                   </div>
                 </div>
